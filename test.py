...
class Database:
    def __init__(self, FileName: str) -> None: ## Constructor method of Database class
        ...
        self.GenerateTable(TableName="Flashcards", PrimaryKey=Attribute("FlashcardID", "INTEGER"), AutoIncrementPrimaryKey=True,
        ...
        self.GenerateTable(TableName="RevisionSessions", PrimaryKey=Attribute("SessionID", "INTEGER"), AutoIncrementPrimaryKey=True,
        ...
        self.GenerateTable(TableName="TimetableSlots", PrimaryKey=Attribute("TimetableSlotID", "INTEGER"), AutoIncrementPrimaryKey=True,
        ...
        self.GenerateTable(TableName="Timetable", PrimaryKey=Attribute("TimetableID", "INTEGER"), AutoIncrementPrimaryKey=True,
